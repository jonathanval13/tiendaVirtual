        ...
        <?php print('<form action="../crud/create.php?producto='.$_GET['producto'].'" enctype="multipart/form-data" method="POST">') ?>
            ...
            <table class="tabla-cel">
                ...
                <tr>
                    ...
                    <td><input type="text" name="camarap" required></td>
                    <td>Camara frontal</td>
                    <td><input type="text" name="camaraf" required></td>
                </tr>                 
                ...
                <tr>
                    ...
                    <td><input type="text" name="vprocesador" required></td>
               </tr>
        
                <tr> 
                    <td>Nucleos</td>
                    <td><input type="text" name="nucleos" required></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="almacenamiento" required></td>
                    <td>Referencia</td>
