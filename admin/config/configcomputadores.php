        ...
        <?php print('<form action="../crud/update.php?producto='.$_GET['producto'].'&id='.$_GET['id'].'" enctype="multipart/form-data" method="POST">') ?>
            ...
            <table class="tabla-cel">
                ...
                <tr>
                    ...
                    <td><input type="text" name="tarjetagrafica" value="<?php print($producto['tarjetagrafica']) ?>"></td>
                    <td>Disco duro</td>
                    <td><input type="text" name="discoduro" value="<?php print($producto['discoduro']) ?>"></td>
                </tr>                 
                ...
                <tr>
                   ...
                   <td>RAM</td>
                    <td><input type="text" name="ram" value="<?php print($producto['ram']) ?>"></td>
                </tr>
                ...
                <tr>
                    <td>Referencia</td>
                    <td><input type="text" name="id" value="<?php print($producto['id']) ?>"></td>
                </tr>
                <tr>
                    <td>Imagen</td>
